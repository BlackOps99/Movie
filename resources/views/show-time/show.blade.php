    ...
    <div class="flex flex-wrap mt-6 -mx-3">
                    ...
                    <div class="py-4 pr-1 mb-4 rounded-xl">
                        <div>
                            <img src="{{ $showtime->movie->picture }}"
                                class="inline-flex items-center justify-center mr-4 text-sm text-white transition-all duration-200 ease-soft-in-out h-full w-full object-contain rounded-xl"
                                alt="movie-image" />
                        </div>
                    </div>
                    <h6 class="mt-6 mb-0 ml-2">{{ $showtime->movie->name }}</h6>
        ...
        <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            ...
            <div
                ...
                <div class="flex-auto p-4">
                    <p>
                        Day: {{ \Carbon\Carbon::parse($showtime->datetime)->format('d/m/Y') }}
                    </p>
                    <p>
                        Time: {{ \Carbon\Carbon::parse($showtime->time)->format('h:i A') }}
                    </p>
                    <hr>
                </div>
            </div>
